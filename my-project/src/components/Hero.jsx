...
const Hero = () =>  (
    ...
    md:flex-row flex-column ${styles.paddingY} 
    `}>
      <div className= { ` flex-1 ${styles.flexStart} 
      flex-col px-6 xl:px-0 sm:px-16`}>
        <div className= {` flex flex-row
        item-centre py-[6px] px-4 bg-discount-gradient 
        rounded-[10px] mb-2`}>
        ...
        <p className={ `${styles.paragraph} max-w-[470px] mt-5`}>
          ...
          to identify the credit cards mostl likely 
